                        ...
                        children: <Widget>[
                          ListTile(
                                    ...
                                    SimpleDialogOption(
                                      ...
                                      onPressed: () {
                                        ...
                                        PartyData dataa = PartyData(
                                            ...
                                            defaultDiscount: partyList[
                                                'partyDefaultDiscount']);
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                                builder: (context) =>
                            ...
                            onTap: () {
                              ...
                              //  Navigator.push(context, MaterialPageRoute(builder: (context) => ExpiryList(partyList.id, partName)));
                            },
                            leading: new CircleAvatar(
                              child: Text('${partyList['partyName'][0]}'),
...
class DataSearch extends SearchDelegate<String> {
  ...
  Widget buildSuggestions(BuildContext context) {
    final suggestionList = query.isEmpty
        ? partyName
        : partyName.where((p) => p.startsWith(query.toUpperCase())).toList();
      ...
      itemBuilder: (context, index) => ListTile(
        ...
        onTap: () {
          ...
          PartyData data = PartyData(
              ...
              defaultDiscount: disc[suggestionList[index]]);
          Navigator.push(context,
