  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Transaction History", style: TextStyle(color: Colors.white, fontSize: 22.0, fontWeight: FontWeight.w600),),
       actions: [
      ...
      body: StreamBuilder(
        stream: Firestore.instance.collection("Expiry").where('partyName', isEqualTo: widget.data.name).orderBy('timestamp', descending: true).snapshots(),
                    ...
                    leading: Container(
                      ...
                      decoration: new BoxDecoration(
                        border: new Border(
                          ...
                          child: IconButton(icon: prodList['isSettled']?Icon(Icons.check, color: Colors.green, size: 40):Icon(Icons.clear, color: Colors.red, size: 40), onPressed: (){
                                ...
                                return AlertDialog(
                                  ...
                                  content: TextField(
                                              ...
                                              onSubmitted: (text) {
                                                ...
                                                Firestore.instance.collection('Expiry').document(prodList.documentID).setData({"invoiceNumber": invoice, "isSettled" : true, "partyName" : prodList['partyName'], "timestamp" : prodList['timestamp'], "amount" : prodList['amount']});
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                ...
                Text(day + "/"  + month + "/" + year, style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold, fontSize: 16))
              ],
            ),
